...
export function normalizeBinanceUsdmRegularOpenOrder(
  ...
  return {
    ...
    customClientOrderId: readClientOrderId(row),
    side: row.side,
    type: row.type,
    ...
    facts.push(
      createTerminalEvidenceFact(
        scope,
        {
          ...
          customClientOrderId: order.clientOrderId,
        },
  ...
  return [
    {
      ...
      fill: {
        ...
        customClientOrderId: event.clientOrderId,
        side: event.side,
  ...
  if (isTerminalOrderStatus(status)) {
    facts.push(
      createTerminalEvidenceFact(
        ...
        {
          exchangeOrderId: String(event.orderId),
          customClientOrderId: event.newClientOrderId,
        },
        terminalReasonFromOrderStatus(status),
        event.eventTime,
      ),
